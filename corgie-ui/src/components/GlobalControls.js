            ...
            <div id="global-controls" className="view">
                ...
                <div className="view-body">
                    <Table responsive borderless size="sm">
                        <tbody>
                            <tr>
                                <td rowSpan={nodeTypes.length > 1 ? 3 : 2} style={{ width: "110px" }}>
                                    <div style={{ verticalAlign: "middle" }}>Node visuals</div>
                                </td>
                                        ...
                                        >
                                            ...
                                            <Dropdown.Menu>
                                                ...
                                                {numNodeClasses && (
                                                    <div>
                                                        <Dropdown.Divider />
                                                        {["pred-labels", "true-labels", "correctness"].map(
                                                            (k) => (
                                                                <Dropdown.Item
                                                                    key={k}
                                                                    eventKey={k}
                            ...
                            <tr>
                                <td rowSpan={nodeTypes.length > 1 || numNodeClasses ? 2 : 1}>Interaction</td>
                                <td colSpan={2}>
